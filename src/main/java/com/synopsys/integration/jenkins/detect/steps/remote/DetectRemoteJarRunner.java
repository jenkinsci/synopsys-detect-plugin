...
public class DetectRemoteRunner implements Callable<DetectResponse, IntegrationException> {
    ...
    public DetectRemoteRunner(final JenkinsDetectLogger logger, final String javaHome, final String detectDownloadUrl, final String toolsDirectory, final List<String> detectProperties, final EnvVars envVars) {
        this.logger = logger;
