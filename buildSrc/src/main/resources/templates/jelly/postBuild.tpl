...
import static com.synopsys.integration.jenkins.blackduck.GenerateJelly.SELECT
import static com.synopsys.integration.jenkins.blackduck.GenerateJelly.TEXTBOX
